...
public class PieChartData extends AbstractChartData {
    public static final int DEFAULT_CENTER_TEXT1_SIZE_SP = 30;
    public static final int DEFAULT_CENTER_TEXT2_SIZE_SP = 10;
    public static final float DEFAULT_CENTER_CIRCLE_SCALE = 0.2f;
