...
public abstract class ChartUtils {
    ...
    public static final int COLOR_MAGENTA = Color.parseColor("#FF00FF");
    public static final int COLOR_LIME = Color.parseColor("#00FF00");
    public static final int COLOR_AQUA = Color.parseColor("#93FFE8");
    public static final int COLOR_TEAL = Color.parseColor("#008080");
    public static final int COLOR_CREAM = Color.parseColor("#FFFFCC");
    public static final int COLOR_ROSE = Color.parseColor("#E8ADAA");
    public static final int[] COLORS = new int[]{COLOR_BLUE, COLOR_VIOLET, COLOR_GREEN, COLOR_ORANGE,
            COLOR_RED, COLOR_YELLOW, COLOR_MAGENTA,COLOR_LIME, COLOR_ROSE,COLOR_AQUA,
            COLOR_TEAL,COLOR_CREAM, Color.CYAN, Color.DKGRAY};
    ...
    public static final int nextColor(int COLOR_INDEX) {
