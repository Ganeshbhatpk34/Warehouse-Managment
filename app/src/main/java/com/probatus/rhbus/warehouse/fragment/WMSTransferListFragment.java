...
public class WMSTransferListFragment extends Fragment
    ...
    private ArrayList<productversion> prepareData(){
        ...
        ((JobViewActivity) getActivity()).jsonResponse.JsonResponse(getActivity(), "wmsTrasnferAdv_android", "getAlltranferformaple", list, new HttpResponse<JSONObject>() {
            public void onResponse(JSONObject response) {
                try {
                    ...
                    for (int i = 0; i < array.length(); i++) {
                        ...
                        productversion.setAndroid_version_name(code);
                        ...
                        productversion.setProduct_category(name + " -> " + address);
                        productversion.setProduct_subcategory(location + " -> " + address2);
    ...
    public void onClick(final View view, int posi) {
        ...
        ((JobViewActivity) getActivity()).transferToNextForTransfer();
    }
